...
public abstract class Source<I, O, T> {
	...
	/**
	 * Get the source's opinion. This includes the result of the source, and the
	 * trust/confidence of the source.
	 * 
	 * @param args
	 *            The arguments passed to the CI
	 * @return The source's opinion.
	 * @throws UnknownException
	 *             The source wasn't avaliable, so no answer could be obtained
	 */
	 ...
	 * 
	 * @param value
	 *            The response which the source provided (the value returned by
	 *            getResponse)
	 * @param args
