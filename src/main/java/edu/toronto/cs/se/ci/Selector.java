...
public interface Selector<I, O, T> {
	...
	/**
	 * Get an Optional containing the next source to be consulted by the CI.
	 * This function will be called repeatedly until it returns
	 * {@code Optional.absent()}, at which point, the CI will stop calling
	 * functions. It may block to wait for sources to be consulted.
	 * 
	 * @param invocation
