...
public final class Budgets {
	...
	/**
	 * Produce a new budget, as though cost had been spent in the original budget
	 * 
	 * @param budget The budget to spend the cost from
	 * @param cost The cost to spend from the budget
	 * @return A new budget, or Optional.absent() if the budget cannot support the cost
	 */
	 ...
	 * Produce a new budget, as though cost had been spent in the original budget
	 * 
	 * <p>This call will allow the functions to interact with the current CI invocation
	 * 
	 * @param budget The budget to spend the cost from
	 * @param cost The cost to spend from the budget
