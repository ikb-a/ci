...
/**
 * Wraps around a source, transforming its inputs and outputs, allowing a source
 * to fulfil multiple different contracts.
 * 
 * @author michael
 *
 * @param <I>
 ...
 * @param <O>
 *            New Source Output Type
 * @param <T>
 *            New Source Trust Type
 * @param <OI>
 *            Original Source Input Type
 * @param <OO>
 *            Original Source Output Type
 * @param <OT>
 *            Original Source Trust Type
 */
public abstract class Adaptor<I, O, T, OI, OO, OT> implements Provider<I, O, T> {
	 ...
	 * 
	 * @param around
	 *            The contract to wrap around. Contract discovery will be used
	 *            to {@link provide()}
	 */
	...
	/**
	 * Discover all sources which are wrapped by this adaptor, and generate
	 * concrete adapted sources.
	 * 
	 ...
	 * 
	 * @param args
	 *            The input arguments to the Source
	 * @param around
	 *            The source being wrapped
	 ...
	 *             If the source doesn't produce an opinion
	 */
	 ...
	 *            The input arguments to the Source
	 * @param value
	 *            Potentially the value produced by the source
	 * @param around
	 *            The source being wrapped
	...
	/**
	 * Internal concrete implementation of source. Generated by
	 * {@link Adaptor#provide()}
	 * 
	...
	private class SrcAdaptor extends Source<I, O, T> {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.toronto.cs.se.ci.Source#getTrust(java.lang.Object,
