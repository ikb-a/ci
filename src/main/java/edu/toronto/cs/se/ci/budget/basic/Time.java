...
/**
 * The time Allowance represents an amount of time which is available for a
 * computation to be completed in. If the time Allowance is not present, it is
 * assumed that unlimited time is available for the computation to be completed.
 * 
 * The time Expenditure represents the amount of time needed to complete a
 * computation. If it is not present, then it is assumed that the time necessary
 * is negligible.
 * 
